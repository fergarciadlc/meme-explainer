...
const TypewriterEffect = ({ text }) => {
  ...
  useEffect(() => {
    if (index < text.length) {
      ...
      }, 7); // Adjust this value to change typing speed
...
const MemeExplainer = () => {
  ...
  return (
    <div className={`max-w-6xl mx-auto p-6 bg-gray-100 rounded-lg shadow-lg ${error && error.includes('Failed to fetch') ? 'bg-red-100' : ''}`}>
